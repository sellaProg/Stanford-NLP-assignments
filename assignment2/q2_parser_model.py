...
class ParserModel(Model):
    ...
    def add_prediction_op(self):
        ...
        ### YOUR CODE HERE
        xavi=xavier_weight_init()
        W=tf.Variable(xavi((Config.n_features*Config.embed_size,Config.hidden_size)))
        W=tf.cast(W,tf.float32)
        b1=tf.Variable(tf.zeros(shape=(Config.hidden_size,)))
        U=tf.Variable(xavi((Config.hidden_size,Config.n_classes)))
